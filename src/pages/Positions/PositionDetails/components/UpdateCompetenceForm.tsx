...
const UpdateCompetenceForm: React.FC<UpdateMissionFormProps> = ({
  refetch,
  initialvalues,
  position,
}) => {
  ...
  const onSuccess = () => {
    message.success("La compétence a été mise à jour avec succès.");
    setOpen(false);
    refetch();
  };
...
export default UpdateCompetenceForm;
